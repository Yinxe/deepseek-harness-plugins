...
function diffNumRules(blockClass, newStart, delCount, addCount) {
...
function createDiffBody(cn) {
  ...
  return {
    ...
    lines(args) {
      ...
      const numCss = typeof args.newStart === "number" && args.newStart > 0 && args.numClass !== void 0 ? diffNumRules(
        args.numClass,
        args.newStart,
    ...
    if (hunk !== void 0) {
      ...
      if (typeof base === "number" && base > 0) {
        ...
        for (const row of hunk.rows) {
          ...
          if (row.kind === "add" && newStart === void 0) newStart = newLine;
          newLine += 1;
        }
      }
    }
