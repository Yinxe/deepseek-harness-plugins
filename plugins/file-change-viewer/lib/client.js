...
function diffNumRules(blockClass, oldStart, newStart, delCount, addCount) {
  ...
  if (delCount > 0) {
    rules.push(
      rows + ">div:nth-of-type(n+" + delFrom + "):nth-of-type(-n+" + delTo + "){counter-increment:dshp-fcv-old}"
    );
    rules.push(
      rows + ">div:nth-of-type(n+" + delFrom + "):nth-of-type(-n+" + delTo + ")::after{content:counter(dshp-fcv-old);color:var(--dsw-alias-state-error-primary)}"
    );
  }
  if (addCount > 0) {
    rules.push(
      rows + ">div:nth-of-type(n+" + addFrom + "):nth-of-type(-n+" + addTo + "){counter-increment:dshp-fcv-new}"
    );
    rules.push(
      rows + ">div:nth-of-type(n+" + addFrom + "):nth-of-type(-n+" + addTo + ")::after{content:counter(dshp-fcv-new);color:var(--dsw-alias-state-success-primary)}"
    );
  }
  return rules.join("\n");
}
...
function createDiffBody(cn) {
  ...
  return {
    ...
    lines(args) {
      ...
      const numCss = typeof args.oldStart === "number" && args.oldStart > 0 && typeof args.newStart === "number" && args.newStart > 0 && args.numClass !== void 0 ? diffNumRules(
        args.numClass,
        args.oldStart,
        args.newStart,
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: cn.diffWrap, children: [
        numCss !== "" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("style", { children: numCss }, "num") : null,
...
var css = '._0K34_a_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}._0K34_a_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);flex:auto;overflow:hidden}._0K34_a_path{text-overflow:ellipsis;white-space:nowrap;min-width:0;font:inherit;text-align:left;font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-secondary);text-decoration:underline dotted;text-decoration-color:var(--dsw-alias-label-tertiary);text-underline-offset:3px;cursor:pointer;background:0 0;border:none;flex:0 auto;margin:0;padding:0;text-decoration-thickness:1px;overflow:hidden}._0K34_a_path:hover{color:var(--dsw-alias-label-primary);text-decoration-color:currentColor}._0K34_a_stat{white-space:nowrap;font-family:var(--ds-font-family-code);font-size:calc(var(--dsh-content-font-size-secondary,13px) - 2px);flex:none;align-items:center;gap:10px;margin-left:10px;display:inline-flex;transform:translateY(.5px)}._0K34_a_statPart{align-items:center;gap:3px;display:inline-flex}._0K34_a_add{color:var(--dsw-alias-state-success-primary)}._0K34_a_del{color:var(--dsw-alias-state-error-primary)}._0K34_a_note{color:var(--dsw-alias-label-caption)}._0K34_a_errorSummary{font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-state-error-primary);text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}._0K34_a_body{--fcv-del-bg:var(--dsw-alias-interactive-bg-hover-danger);--fcv-add-bg:var(--dsw-alias-state-success-tertiary);flex-direction:column;display:flex}._0K34_a_inspect{border:.5px solid var(--dsw-alias-border-l3);corner-shape:round;background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}._0K34_a_rowRoot:hover ._0K34_a_inspect,._0K34_a_inspect:focus-visible{opacity:1}._0K34_a_inspect:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}._0K34_a_card{border:.5px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-markdown-code-block);border-radius:12px;margin:6px 0 8px 4px;overflow:hidden}._0K34_a_card ._0K34_a_cardRow{background:var(--dsw-alias-markdown-code-block-banner);border-bottom:.5px solid var(--dsw-alias-border-l1);gap:4px;height:auto;min-height:30px;padding:0 10px}._0K34_a_card ._0K34_a_cardTitle{min-width:0;color:var(--dsw-alias-label-secondary);flex:1;align-items:center;font-size:12px;display:inline-flex}._0K34_a_cardName{align-items:center;gap:6px;min-width:0;max-width:100%;display:inline-flex}._0K34_a_cardNameText{text-overflow:ellipsis;white-space:nowrap;font-family:var(--ds-font-family-code);overflow:hidden}._0K34_a_fileIcon{flex:none;align-items:center;display:inline-flex}._0K34_a_card ._0K34_a_cardRow:hover ._0K34_a_cardTitle{color:var(--dsw-alias-label-primary)}._0K34_a_viewGroup{flex:none;align-items:center;gap:4px;margin-left:6px;display:inline-flex}._0K34_a_viewPill{border-radius:10px;gap:4px;height:20px;padding:0 8px;font-size:11px;line-height:18px}._0K34_a_viewPill svg{flex:none}._0K34_a_card ._0K34_a_code{--dsl-code-block-line-white-space:pre;border-radius:0;margin:0;background:0 0!important}._0K34_a_card ._0K34_a_code>div:has([data-code-block-banner]),._0K34_a_card ._0K34_a_code [data-code-block-banner]{display:none}._0K34_a_card ._0K34_a_code pre{border-radius:0;padding:8px 0;background:0 0!important}._0K34_a_card ._0K34_a_code pre code>.line{box-sizing:border-box;width:max-content;min-width:100%}._0K34_a_card ._0K34_a_diff[data-diff]>button,._0K34_a_card ._0K34_a_diff[data-diff]>div:last-of-type,._0K34_a_card ._0K34_a_diff[data-diff]>div:first-of-type>div:first-child{display:none}._0K34_a_diffWrap{flex-direction:column;display:flex;overflow:auto hidden}._0K34_a_ctx{font:var(--dsw-font-markdown-code-block);color:var(--dsw-alias-label-tertiary);white-space:pre;padding:0 14px}._0K34_a_card ._0K34_a_diff[data-diff]>div>div{position:relative}._0K34_a_card ._0K34_a_diff[data-diff]>div>div:after{text-align:end;opacity:.7;user-select:none;pointer-events:none;width:3ch;position:absolute;inset-inline-start:0}._0K34_a_ctxLine{counter-increment:dshp-fcv-num;white-space:pre;min-height:22px}._0K34_a_ctxLine:before{content:counter(dshp-fcv-num);text-align:end;width:3ch;color:var(--dsw-alias-label-tertiary);opacity:.7;user-select:none;margin-inline-end:12px;display:inline-block}._0K34_a_card ._0K34_a_ctx:first-child{padding-top:8px}._0K34_a_card ._0K34_a_ctx:last-child{padding-bottom:8px}._0K34_a_card ._0K34_a_diff[data-diff]>div:first-of-type{overflow:visible}._0K34_a_diffWrap>._0K34_a_ctx+._0K34_a_diff[data-diff]>div:first-of-type{padding-top:0}._0K34_a_diffWrap>._0K34_a_diff[data-diff]:has(+._0K34_a_ctx)>div:last-of-type{padding-bottom:0}._0K34_a_card ._0K34_a_diff{border-radius:0;margin:0}._0K34_a_muted{color:var(--dsw-alias-label-tertiary);margin:0;padding:6px 10px 8px;font-size:12px;line-height:18px}._0K34_a_page{max-width:720px;color:var(--dsw-alias-label-primary);flex-direction:column;display:flex}._0K34_a_intro{color:var(--dsw-alias-label-tertiary);margin:0 0 4px;font-size:14px;line-height:22px}._0K34_a_section{flex-direction:column;width:100%;display:flex}._0K34_a_sectionHead{color:var(--dsw-alias-label-secondary);padding:14px 0 2px;font-size:12px;font-weight:500;line-height:18px}._0K34_a_settingRow{border-bottom:.5px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}._0K34_a_section ._0K34_a_settingRow:last-child{border-bottom:none}._0K34_a_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}._0K34_a_settingBlock{border-bottom:.5px solid var(--dsw-alias-border-l2);flex-direction:column;gap:12px;padding:16px 0;display:flex}._0K34_a_section ._0K34_a_settingBlock:last-child{border-bottom:none}._0K34_a_blockText{flex-direction:column;gap:4px;display:flex}._0K34_a_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}._0K34_a_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:400;line-height:18px}._0K34_a_barEnd{flex-wrap:wrap;justify-content:flex-end;align-items:center;gap:8px;padding:12px 0;display:flex}._0K34_a_notice{margin:0;font-size:12px;line-height:18px}._0K34_a_noticeErr{color:var(--dsw-alias-state-error-primary)}._0K34_a_badge{white-space:nowrap;border-radius:10px;align-items:center;height:20px;padding:0 8px;font-size:11px;font-weight:500;line-height:20px;display:inline-flex}._0K34_a_badgeOk{background:var(--dsw-alias-state-success-tertiary);color:var(--dsw-alias-state-success-primary)}._0K34_a_badgeWarn{background:var(--dsw-alias-state-warn-tertiary);color:var(--dsw-alias-state-warn-label)}._0K34_a_badgeMuted{background:var(--dsw-alias-button-ghost-active-fill);color:var(--dsw-alias-label-caption)}._0K34_a_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;max-width:100%;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}._0K34_a_selector:hover{background:var(--dsw-alias-interactive-bg-hover)}._0K34_a_selector:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:2px}._0K34_a_selectorLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}._0K34_a_chevron{flex:none}._0K34_a_switch{box-sizing:border-box;background:var(--dsw-alias-border-l3);cursor:pointer;border:0;border-radius:10px;flex:none;width:36px;height:20px;padding:2px;position:relative}._0K34_a_switchOn{background:var(--dsw-alias-brand-primary)}._0K34_a_switch:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:2px}._0K34_a_thumb{background:var(--dsw-alias-label-primary-foreground);border-radius:50%;width:16px;height:16px;transition:transform .12s;display:block}._0K34_a_switchOn ._0K34_a_thumb{transform:translate(16px)}@media (prefers-reduced-motion:reduce){._0K34_a_thumb{transition:none}}._0K34_a_viewCards{grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:12px;display:grid}._0K34_a_viewCard{background:var(--dsw-alias-bg-base);cursor:pointer;border:.5px solid var(--dsw-alias-border-l2);border-radius:12px;flex-direction:column;gap:8px;padding:12px;transition:border-color .12s,background .12s;display:flex}._0K34_a_viewCard:hover{border-color:var(--dsw-alias-border-l4);background:var(--dsw-alias-interactive-bg-hover)}._0K34_a_viewCardOn,._0K34_a_viewCardOn:hover{border-color:var(--dsw-alias-brand-primary)}._0K34_a_viewCard:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:2px}._0K34_a_viewCardHead{align-items:center;gap:8px;display:flex}._0K34_a_viewCardName{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:500;line-height:22px}._0K34_a_viewCardDesc{color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:18px}._0K34_a_radio{box-sizing:border-box;border:1.5px solid var(--dsw-alias-border-l4);border-radius:50%;flex:none;width:16px;height:16px;position:relative}._0K34_a_viewCardOn ._0K34_a_radio{border-color:var(--dsw-alias-brand-primary)}._0K34_a_viewCardOn ._0K34_a_radio:after{content:"";background:var(--dsw-alias-brand-primary);border-radius:50%;position:absolute;inset:3px}._0K34_a_pvBody{pointer-events:none;--fcv-del-bg:var(--dsw-alias-interactive-bg-hover-danger);--fcv-add-bg:var(--dsw-alias-state-success-tertiary);background:var(--dsw-alias-markdown-code-block);border:.5px solid var(--dsw-alias-border-l1);border-radius:8px;flex-direction:column;display:flex;overflow:hidden}._0K34_a_pvCodeBox{flex-direction:column;display:flex}._0K34_a_pvCode{--dsl-code-block-line-white-space:pre;border-radius:0;margin:0;background:0 0!important}._0K34_a_pvCode>div:has([data-code-block-banner]),._0K34_a_pvCode [data-code-block-banner]{display:none}._0K34_a_pvCode pre{border-radius:0;padding:8px 0;background:0 0!important}._0K34_a_pvCode pre code>.line{box-sizing:border-box;width:max-content;min-width:100%}._0K34_a_pvDiff{border-radius:0;margin:0}._0K34_a_pvDiffWrap{flex-direction:column;display:flex;overflow:auto hidden}._0K34_a_pvCtx{font:var(--dsw-font-markdown-code-block);color:var(--dsw-alias-label-tertiary);white-space:pre;padding:0 14px}._0K34_a_pvDiff[data-diff]>div:first-of-type{overflow:visible}._0K34_a_pvCtxLine{white-space:pre;min-height:22px}._0K34_a_pvMuted{color:var(--dsw-alias-label-tertiary);margin:0;padding:6px 10px 8px;font-size:12px;line-height:18px}._0K34_a_headCtl{border:.5px solid var(--dsw-alias-border-l4);border-radius:14px;align-items:stretch;height:28px;display:inline-flex;overflow:hidden}._0K34_a_headCtlOverridden{border-color:var(--dsw-alias-brand-primary)}._0K34_a_headBtn{color:var(--dsw-alias-label-primary);cursor:pointer;white-space:nowrap;font-family:var(--dsw-font-family);background:0 0;border:0;align-items:center;gap:5px;padding:5px 8px;font-size:11px;font-weight:400;line-height:16px;display:inline-flex}._0K34_a_headBtn:hover,._0K34_a_headBtn:focus-visible{background:var(--dsw-alias-interactive-bg-hover)}._0K34_a_headBtn:focus-visible{outline:none}._0K34_a_headSep{background:var(--dsw-alias-border-l4);flex:none;width:.5px}._0K34_a_headLabel{color:var(--dsw-alias-label-secondary)}._0K34_a_headChevron{flex:none;transition:transform .12s}._0K34_a_headChevronShut{transform:rotate(-90deg)}._0K34_a_headReset{color:var(--dsw-alias-label-secondary);cursor:pointer;border:0;border-left:.5px solid var(--dsw-alias-border-l4);background:0 0;align-items:center;padding:5px 7px;display:inline-flex}._0K34_a_headReset:hover,._0K34_a_headReset:focus-visible{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}._0K34_a_headReset:focus-visible{outline:none}@media (prefers-reduced-motion:reduce){._0K34_a_headChevron{transition:none}}';
...
var styles_module_css_default = { "add": "_0K34_a_add", "badge": "_0K34_a_badge", "badgeMuted": "_0K34_a_badgeMuted", "badgeOk": "_0K34_a_badgeOk", "badgeWarn": "_0K34_a_badgeWarn", "barEnd": "_0K34_a_barEnd", "blockText": "_0K34_a_blockText", "body": "_0K34_a_body", "card": "_0K34_a_card", "cardName": "_0K34_a_cardName", "cardNameText": "_0K34_a_cardNameText", "cardRow": "_0K34_a_cardRow", "cardTitle": "_0K34_a_cardTitle", "chevron": "_0K34_a_chevron", "code": "_0K34_a_code", "ctx": "_0K34_a_ctx", "ctxLine": "_0K34_a_ctxLine", "del": "_0K34_a_del", "desc": "_0K34_a_desc", "diff": "_0K34_a_diff", "diffWrap": "_0K34_a_diffWrap", "errorSummary": "_0K34_a_errorSummary", "fileIcon": "_0K34_a_fileIcon", "headBtn": "_0K34_a_headBtn", "headChevron": "_0K34_a_headChevron", "headChevronShut": "_0K34_a_headChevronShut", "headCtl": "_0K34_a_headCtl", "headCtlOverridden": "_0K34_a_headCtlOverridden", "headLabel": "_0K34_a_headLabel", "headReset": "_0K34_a_headReset", "headSep": "_0K34_a_headSep", "inspect": "_0K34_a_inspect", "intro": "_0K34_a_intro", "muted": "_0K34_a_muted", "note": "_0K34_a_note", "notice": "_0K34_a_notice", "noticeErr": "_0K34_a_noticeErr", "page": "_0K34_a_page", "path": "_0K34_a_path", "pvBody": "_0K34_a_pvBody", "pvCode": "_0K34_a_pvCode", "pvCodeBox": "_0K34_a_pvCodeBox", "pvCtx": "_0K34_a_pvCtx", "pvCtxLine": "_0K34_a_pvCtxLine", "pvDiff": "_0K34_a_pvDiff", "pvDiffWrap": "_0K34_a_pvDiffWrap", "pvMuted": "_0K34_a_pvMuted", "radio": "_0K34_a_radio", "rowRoot": "_0K34_a_rowRoot", "rowText": "_0K34_a_rowText", "section": "_0K34_a_section", "sectionHead": "_0K34_a_sectionHead", "selector": "_0K34_a_selector", "selectorLabel": "_0K34_a_selectorLabel", "sep": "_0K34_a_sep", "settingBlock": "_0K34_a_settingBlock", "settingRow": "_0K34_a_settingRow", "stat": "_0K34_a_stat", "statPart": "_0K34_a_statPart", "summary": "_0K34_a_summary", "switch": "_0K34_a_switch", "switchOn": "_0K34_a_switchOn", "thumb": "_0K34_a_thumb", "title": "_0K34_a_title", "viewCard": "_0K34_a_viewCard", "viewCardDesc": "_0K34_a_viewCardDesc", "viewCardHead": "_0K34_a_viewCardHead", "viewCardName": "_0K34_a_viewCardName", "viewCardOn": "_0K34_a_viewCardOn", "viewCards": "_0K34_a_viewCards", "viewGroup": "_0K34_a_viewGroup", "viewPill": "_0K34_a_viewPill" };
...
function FileChangeRow(props) {
  ...
  const renderStat = (added, removed) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: styles_module_css_default.stat, children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: styles_module_css_default.statPart + " " + styles_module_css_default.add, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_dsh_client_ui_primitives2.IconPlusOutline16, { size: ICON_SIZE }),
      String(added)
    ] }),
  ...
  const renderViewSwitch = (index, current) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: styles_module_css_default.viewGroup, role: "group", "aria-label": VIEW_GROUP_LABEL, children: [
      pill("highlight", VIEW_HIGHLIGHT_LABEL, /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_dsh_client_ui_primitives2.IconCodeOutline16, { size: ICON_SIZE })),
      pill("diff", VIEW_DIFF_LABEL, /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_dsh_client_ui_primitives2.IconBranchOutline16, { size: ICON_SIZE }))
    ] });
  };
  ...
  const renderDiff = (index, fallback2) => {
    ...
    const hunk = model.hunks[index];
    const located = locatedHunks[index];
    const locatedLine = located === null || located === void 0 ? null : located.line;
    let oldStart;
    let newStart;
    if (hunk !== void 0 && typeof locatedLine === "number" && locatedLine > 0) {
      ...
      for (const row of hunk.rows) {
        if (row.kind === "ctx") {
          ...
          if (oldStart === void 0) oldStart = oldLine;
          oldLine += 1;
        } else {
          if (newStart === void 0) newStart = newLine;
          newLine += 1;
        }
      }
    } else if (hunk !== void 0 && typeof hunk.raw.startLine === "number" && hunk.raw.startLine > 0) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
    import_dsh_client_ui_primitives2.DisclosureRow,
    {
      ...
      icon: model.state === "error" ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_dsh_client_ui_primitives2.StateDot, { state: "error" }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_dsh_client_ui_primitives2.IconEditOutline16, { size: 14 }),
  ...
  const selector = /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
    "button",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_dsh_client_ui_primitives3.IconChevronDownOutline14, { className: styles_module_css_default.chevron })
      ]
    }
  );
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
  ...
  const children = [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
      "button",
      {
        ...
        children: [
          view === "highlight" ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_dsh_client_ui_primitives4.IconCodeOutline16, { size: ICON_SIZE2 }) : /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_dsh_client_ui_primitives4.IconBranchOutline16, { size: ICON_SIZE2 }),
    ...
    children.push(
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
        "button",
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_dsh_client_ui_primitives4.IconRefreshOutline14, { size: ICON_SIZE2 })
        },
        "reset"
      )
    );
