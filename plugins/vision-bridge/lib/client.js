...
var css = ".JaftwG_page{max-width:720px;color:var(--dsw-alias-label-primary);flex-direction:column;display:flex}.JaftwG_section{flex-direction:column;width:100%;display:flex}.JaftwG_sectionHead{color:var(--dsw-alias-label-secondary);padding:14px 0 2px;font-size:12px;font-weight:500;line-height:18px}.JaftwG_row{border-bottom:.5px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}.JaftwG_section .JaftwG_row:last-child{border-bottom:none}.JaftwG_rowWrap{border-bottom:.5px solid var(--dsw-alias-border-l2);flex-direction:column;align-items:flex-start;gap:8px;padding:16px 0;display:flex}.JaftwG_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}.JaftwG_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.JaftwG_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:400;line-height:18px}.JaftwG_intro{color:var(--dsw-alias-label-tertiary);margin:0 0 4px;font-size:14px;line-height:22px}.JaftwG_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;max-width:100%;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}.JaftwG_selector:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.JaftwG_selector:disabled{cursor:default;opacity:.4}.JaftwG_selectorLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.JaftwG_chevron{flex:none}.JaftwG_switch{box-sizing:border-box;background:var(--dsw-alias-border-l3);cursor:pointer;border:0;border-radius:10px;flex:none;width:36px;height:20px;padding:2px;position:relative}.JaftwG_switchOn{background:var(--dsw-alias-brand-primary)}.JaftwG_switch:disabled{cursor:default;opacity:.5}.JaftwG_switch:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:2px}.JaftwG_thumb{corner-shape:round;background:var(--dsw-alias-label-primary-foreground);border-radius:50%;width:16px;height:16px;transition:transform .12s;display:block}.JaftwG_switchOn .JaftwG_thumb{transform:translate(16px)}.JaftwG_textarea{box-sizing:border-box;border:.5px solid var(--dsw-alias-border-l4);background:var(--dsw-alias-bg-layer-1);font:inherit;color:var(--dsw-alias-label-primary);resize:vertical;border-radius:8px;outline:none;width:100%;min-height:72px;padding:8px 12px;font-size:13px;line-height:20px}.JaftwG_textarea:focus-visible{border-color:var(--dsw-alias-brand-primary)}.JaftwG_textarea::placeholder{color:var(--dsw-alias-label-dimmed)}.JaftwG_textarea:disabled{opacity:.5}.JaftwG_badge{white-space:nowrap;border-radius:10px;align-items:center;height:20px;padding:0 8px;font-size:11px;font-weight:500;line-height:20px;display:inline-flex}.JaftwG_badgeOk{background:var(--dsw-alias-state-success-tertiary);color:var(--dsw-alias-state-success-primary)}.JaftwG_badgeWarn{background:var(--dsw-alias-state-warn-tertiary);color:var(--dsw-alias-state-warn-label)}.JaftwG_badgeMuted{background:var(--dsw-alias-button-ghost-active-fill);color:var(--dsw-alias-label-caption)}.JaftwG_badgeInfo{background:var(--dsw-alias-state-business-tertiary);color:var(--dsw-alias-state-business-primary)}.JaftwG_notice{margin:0;font-size:12px;line-height:18px}.JaftwG_noticeErr{color:var(--dsw-alias-state-error-primary)}.JaftwG_noticeWarn{color:var(--dsw-alias-state-warn-label)}.JaftwG_hint{color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;line-height:18px}.JaftwG_loading{align-items:center;gap:8px;display:flex}.JaftwG_loadingText{color:var(--dsw-alias-label-tertiary);font-size:13px;line-height:20px}.JaftwG_bar{border-bottom:.5px solid var(--dsw-alias-border-l2);flex-wrap:wrap;align-items:center;gap:8px;padding:16px 0;display:flex}.JaftwG_section .JaftwG_bar{border-bottom:none}.JaftwG_modelLine{justify-content:flex-end;align-items:center;gap:6px;min-width:0;max-width:100%;display:inline-flex}@media (prefers-reduced-motion:reduce){.JaftwG_thumb{transition:none}}";
...
var styles_module_css_default = { "badge": "JaftwG_badge", "badgeInfo": "JaftwG_badgeInfo", "badgeMuted": "JaftwG_badgeMuted", "badgeOk": "JaftwG_badgeOk", "badgeWarn": "JaftwG_badgeWarn", "bar": "JaftwG_bar", "chevron": "JaftwG_chevron", "desc": "JaftwG_desc", "hint": "JaftwG_hint", "intro": "JaftwG_intro", "loading": "JaftwG_loading", "loadingText": "JaftwG_loadingText", "modelLine": "JaftwG_modelLine", "notice": "JaftwG_notice", "noticeErr": "JaftwG_noticeErr", "noticeWarn": "JaftwG_noticeWarn", "page": "JaftwG_page", "row": "JaftwG_row", "rowText": "JaftwG_rowText", "rowWrap": "JaftwG_rowWrap", "section": "JaftwG_section", "sectionHead": "JaftwG_sectionHead", "selector": "JaftwG_selector", "selectorLabel": "JaftwG_selectorLabel", "switch": "JaftwG_switch", "switchOn": "JaftwG_switchOn", "textarea": "JaftwG_textarea", "thumb": "JaftwG_thumb", "title": "JaftwG_title" };
