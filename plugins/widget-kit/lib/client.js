...
function Card({
  ...
  (0, import_react3.useEffect)(() => {
    ...
    if (rect2.width > 0 && rect2.height > 0) {
      runtime.setCollapsedSize(widget.id, { w: rect2.width, h: rect2.height });
    }
...
function createWidgetRuntime(deps) {
  ...
  function othersOf(exceptId) {
    ...
    for (const [id, card] of Object.entries(state.cards)) {
      ...
      const size = card.minimized ? collapsed.get(id) : void 0;
  ...
  function visualRectOf(id) {
    ...
    return size === void 0 ? rect : { x: rect.x, y: rect.y, w: size.w, h: size.h };
  }
  function setCollapsedSize(id, size) {
    ...
    if (before !== void 0 && before.w === w && before.h === h) return;
  ...
  function setViewport(next) {
    ...
    for (const [id, card] of Object.entries(state.cards)) {
      ...
      const size = card.minimized ? collapsed.get(id) : void 0;
      const visual = size === void 0 ? card : { ...card, w: size.w, h: size.h };
