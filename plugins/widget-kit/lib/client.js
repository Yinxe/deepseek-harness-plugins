...
var SPEC_DEFAULTS = {
  ...
  titleBarHeight: 36,
  contentPadding: 10,
  /** 卡片至少要有这么多 px 留在视口里（标题栏按行可抓回）。 */
  minVisibleTitleBar: 48,
...
function useCardDrag(runtime, widget, mode) {
  ...
  const compute = (0, import_react2.useCallback)(() => {
    ...
    return modeRef.current === "move" ? clampRect({ x: start.x + dx, y: start.y + dy, w: start.w, h: start.h }, constraints, viewport) : applyResize(start, modeRef.current, dx, dy, constraints, viewport);
  }, [runtime, widget]);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: styles_module_css_default.section, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: styles_module_css_default.group, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
        ...
        {
          title: "\u53C2\u8003\u7EC4\u4EF6",
          hint: "\u672C\u63D2\u4EF6\u81EA\u5E26\u7684\u300C\u65F6\u949F\u300D\u4E0E\u300C\u7EC4\u4EF6\u8BCA\u65AD\u300D\uFF08\u89C4\u8303\u793A\u4F8B\uFF0C\u4E0D\u662F\u4E1A\u52A1\uFF1B\u8BCA\u65AD\u80FD\u770B\u5230\u6240\u6709\u63D2\u4EF6\u7684\u6CE8\u518C\u60C5\u51B5\uFF09\u3002",
          children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
            import_dsh_client_ui_primitives5.Switch,
            {
    ...
    ctx.effect(
      () => slots.inject(
        ...
        () => slots.register(
          ...
          (props) => /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(Tray, { runtime, sessionId: props.sessionId ?? null })
        )
      ),
    ...
    ctx.effect(
      () => slots.inject(
        ...
        () => slots.register(
          ...
          () => /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(CardLayer, { runtime, onError: logError })
        )
      ),
