 ...
 *
 * 原实现：dsh-tavily-search/lib/index.js 顶部的 json/sameOrigin/readBody（JS）
 * → 本文件为等价 TS 重写，行为不变。
 */
...
/** 请求方法判定（路由 handler 第一段校验用） */
export function methodIs(req: IncomingMessage, method: string): boolean {
  return (req as { method?: string }).method === method;
}
